...
function updatePasswordField() {
    passwordField.value = getPassword(toggleUppercase.checked, toggleLowercase.checked, toggleNumbers.checked, toggleSpecial.checked, toggleAmbiguous.checked, passwordLength);
}
...
function getPassword(upper, lower, numbers, special, avoidAmbiguous, length) {
    try {
        let allowedChars = getAllowedCharacters(upper, lower, numbers, special, avoidAmbiguous, length).join("");
